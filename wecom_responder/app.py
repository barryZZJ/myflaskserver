...
from wecom_responder.utils.consts import APP_PORT, APP_HOST, APP_HOST6
...
bp_send_to_nspshare_chan, bp_recv_from_nspshare_chan
...
app.register_blueprint(bp_recv_from_nspshare_chan)
app.register_blueprint(bp_send_to_nspshare_chan)
